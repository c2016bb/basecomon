package com.common.base.basecommon.tabs;
...
public class ZTabLayout extends HorizontalScrollView {
    ...
    private static final Pools.Pool<ZTabLayout.Tab> sTabPool = new Pools.SynchronizedPool<>(16);
    ...
    /**
     * Gravity used to fill the {@link ZTabLayout} as much as possible. This option only takes effect
    ...
    /**
     * Gravity used to lay out the tabs in the center of the {@link ZTabLayout}.
     *
     * @see #setTabGravity(int)
     * @see #getTabGravity()
     */
    ...
    private ZTabLayout.Tab mSelectedTab;

    private final ZTabLayout.SlidingTabStrip mTabStrip;
    ...
    private ZTabLayout.OnTabSelectedListener mSelectedListener;
    private final ArrayList<OnTabSelectedListener> mSelectedListeners = new ArrayList<>();
    private ZTabLayout.OnTabSelectedListener mCurrentVpSelectedListener;
    ...
    private ZTabLayout.TabLayoutOnPageChangeListener mPageChangeListener;
    private ZTabLayout.AdapterChangeListener mAdapterChangeListener;
    ...
    public ZTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        // Add the TabStrip
        mTabStrip = new ZTabLayout.SlidingTabStrip(context);
     ...
     */
    public void addTab(@NonNull ZTabLayout.Tab tab) {
     ...
     */
    public void addTab(@NonNull ZTabLayout.Tab tab, int position) {
     ...
     */
    public void addTab(@NonNull ZTabLayout.Tab tab, boolean setSelected) {
     ...
     * @param setSelected True if the added tab should become the selected tab.
     */
    public void addTab(@NonNull ZTabLayout.Tab tab, int position, boolean setSelected) {
        if (tab.mParent != this) {
    ...
    private void addTabFromItemView(@NonNull TabItem item) {
        final ZTabLayout.Tab tab = newTab();
        if (item.mText != null) {
    ...
    /**
     * @deprecated Use {@link #addOnTabSelectedListener(ZTabLayout.OnTabSelectedListener)} and
     * {@link #removeOnTabSelectedListener(ZTabLayout.OnTabSelectedListener)}.
     */
    @Deprecated
    public void setOnTabSelectedListener(@Nullable ZTabLayout.OnTabSelectedListener listener) {
    ...
    /**
     * Add a {@link ZTabLayout.OnTabSelectedListener} that will be invoked when tab selection
     * changes.
     *
     * <p>Components that add a listener should take care to remove it when finished via
     * {@link #removeOnTabSelectedListener(ZTabLayout.OnTabSelectedListener)}.</p>
     *
     * @param listener listener to add
     */
    public void addOnTabSelectedListener(@NonNull ZTabLayout.OnTabSelectedListener listener) {
    ...
    /**
     * Remove the given {@link ZTabLayout.OnTabSelectedListener} that was previously added via
     * {@link #addOnTabSelectedListener(ZTabLayout.OnTabSelectedListener)}.
     *
     * @param listener listener to remove
     */
    public void removeOnTabSelectedListener(@NonNull ZTabLayout.OnTabSelectedListener listener) {
        mSelectedListeners.remove(listener);
    }

    /**
     * Remove all previously added {@link ZTabLayout.OnTabSelectedListener}s.
     */
    ...
    /**
     * Create and return a new {@link ZTabLayout.Tab}. You need to manually add this using
     * {@link #addTab(ZTabLayout.Tab)} or a related method.
     *
     * @return A new Tab
     * @see #addTab(ZTabLayout.Tab)
     */
    @NonNull
    public ZTabLayout.Tab newTab() {
        ZTabLayout.Tab tab = sTabPool.acquire();
        if (tab == null) {
            tab = new ZTabLayout.Tab();
        }
        tab.mParent = this;
     ...
     */
    @Nullable
    public ZTabLayout.Tab getTabAt(int index) {
     ...
     */
    public void removeTab(ZTabLayout.Tab tab) {
        if (tab.mParent != this) {
    ...
    public void removeTabAt(int position) {
        ...
        final ZTabLayout.Tab removedTab = mTabs.remove(position);
        if (removedTab != null) {
            removedTab.reset();
    ...
    public void removeAllTabs() {
        ...
        for (final Iterator<Tab> i = mTabs.iterator(); i.hasNext();) {
            final ZTabLayout.Tab tab = i.next();
            i.remove();
            tab.reset();
     ...
     */
    public void setTabMode(@ZTabLayout.Mode int mode) {
        if (mode != mMode) {
            mMode = mode;
            applyModeAndGravity();
        }
    ...
    /**
     * Returns the current mode used by this {@link ZTabLayout}.
     *
     * @see #setTabMode(int)
     */
    @ZTabLayout.Mode
     ...
     */
    public void setTabGravity(@ZTabLayout.TabGravity int gravity) {
    ...
    /**
     * The one-stop shop for setting up this {@link ZTabLayout} with a {@link ViewPager}.
     *
    ...
    private void setupWithViewPager(@Nullable final ViewPager viewPager, boolean autoRefresh,
        ...
        if (viewPager != null) {
            ...
            if (mPageChangeListener == null) {
                mPageChangeListener = new ZTabLayout.TabLayoutOnPageChangeListener(this);
            }
            mPageChangeListener.reset();
            viewPager.addOnPageChangeListener(mPageChangeListener);

            // Now we'll add a tab selected listener to set ViewPager's current item
            mCurrentVpSelectedListener = new ZTabLayout.ViewPagerOnTabSelectedListener(viewPager);
            ...
            if (mAdapterChangeListener == null) {
                mAdapterChangeListener = new ZTabLayout.AdapterChangeListener();
            }
    ...
    void setPagerAdapter(@Nullable final PagerAdapter adapter, final boolean addObserver) {
        ...
        if (addObserver && adapter != null) {
            ...
            if (mPagerAdapterObserver == null) {
                mPagerAdapterObserver = new ZTabLayout.PagerAdapterObserver();
            }
    ...
    private ZTabLayout.TabView createTabView(@NonNull final ZTabLayout.Tab tab) {
        ZTabLayout.TabView tabView = mTabViewPool != null ? mTabViewPool.acquire() : null;
        if (tabView == null) {
            tabView = new ZTabLayout.TabView(getContext());
        }
        tabView.setTab(tab);
    ...
    private void configureTab(ZTabLayout.Tab tab, int position) {
    ...
    private void addTabView(ZTabLayout.Tab tab) {
        final ZTabLayout.TabView tabView = tab.mView;
    ...
    private void removeTabViewAt(int position) {
        final ZTabLayout.TabView view = (ZTabLayout.TabView) mTabStrip.getChildAt(position);
    ...
    private void animateToTab(int newPosition) {
        if (newPosition == ZTabLayout.Tab.INVALID_POSITION) {
            return;
        }
...
//          LogUtils.D("startScrollX---->"+startScrollX);
//        LogUtils.D("targetScrollX--->"+targetScrollX);
    ...
    void selectTab(ZTabLayout.Tab tab) {
        selectTab(tab, true);
    }

    void selectTab(final ZTabLayout.Tab tab, boolean updateIndicator) {
        final ZTabLayout.Tab currentTab = mSelectedTab;
        ...
        if (currentTab == tab) {
            ...
            final int newPosition = tab != null ? tab.getPosition() : ZTabLayout.Tab.INVALID_POSITION;
            if (updateIndicator) {
                if ((currentTab == null || currentTab.getPosition() == ZTabLayout.Tab.INVALID_POSITION)
                        && newPosition != ZTabLayout.Tab.INVALID_POSITION) {
    ...
    private void dispatchTabSelected(@NonNull final ZTabLayout.Tab tab) {
        for (int i = mSelectedListeners.size() - 1; i >= 0; i--) {
            mSelectedListeners.get(i).onTabSelected(tab);
        }
    }

    private void dispatchTabUnselected(@NonNull final ZTabLayout.Tab tab) {
        for (int i = mSelectedListeners.size() - 1; i >= 0; i--) {
            mSelectedListeners.get(i).onTabUnselected(tab);
        }
    }

    private void dispatchTabReselected(@NonNull final ZTabLayout.Tab tab) {
        for (int i = mSelectedListeners.size() - 1; i >= 0; i--) {
    ...
    public static final class Tab {
         ...
         */
        @NonNull
        public ZTabLayout.Tab setTag(@Nullable Object tag) {
            mTag = tag;
            return this;
        }
         ...
         */
        @NonNull
        public ZTabLayout.Tab setCustomView(@Nullable View view) {
            mCustomView = view;
            updateView();
            return this;
        }
         ...
         */
        @NonNull
        public ZTabLayout.Tab setCustomView(@LayoutRes int resId) {
         ...
         */
        @NonNull
        public ZTabLayout.Tab setIcon(@Nullable Drawable icon) {
            mIcon = icon;
            updateView();
            return this;
        }
         ...
         */
        @NonNull
        public ZTabLayout.Tab setIcon(@DrawableRes int resId) {
            if (mParent == null) {
         ...
         */
        @NonNull
        public ZTabLayout.Tab setText(@Nullable CharSequence text) {
            mText = text;
            updateView();
            return this;
        }
         ...
         */
        @NonNull
        public ZTabLayout.Tab setText(@StringRes int resId) {
            if (mParent == null) {
                throw new IllegalArgumentException("Tab not attached to a TabLayout");
            }
         ...
         */
        @NonNull
        public ZTabLayout.Tab setContentDescription(@StringRes int resId) {
            if (mParent == null) {
                throw new IllegalArgumentException("Tab not attached to a TabLayout");
            }
         ...
         */
        @NonNull
        public ZTabLayout.Tab setContentDescription(@Nullable CharSequence contentDesc) {
    ...
    class TabView extends LinearLayout implements OnLongClickListener {
        ...
        void setTab(@Nullable final ZTabLayout.Tab tab) {
            if (tab != mTab) {
                mTab = tab;
                update();
            }
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        HashMap<Integer,View>mapViews;
        private void updateIndicatorPosition() {

            final View selectedTitle =  getChildAt(mSelectedPosition);
            View selectedTitleTextView=null;
            if (selectedTitle instanceof TabView) {
                selectedTitleTextView = ((TabView)selectedTitle).getmTextView();
            }
            int left, right;

            if (selectedTitleTextView != null && selectedTitleTextView.getWidth() > 0) {
                left =selectedTitle.getLeft()+selectedTitleTextView.getLeft();
                right =selectedTitle.getLeft()+selectedTitleTextView.getRight();
//                LogUtils.D("left--->"+left+"right---->"+right);
                if (mSelectionOffset > 0f && mSelectedPosition < getChildCount() - 1) {
                    // Draw the selection partway between the tabs
                    View nextTitle =  getChildAt(mSelectedPosition + 1);
                    View nextTitleTextView=null;
                    if (nextTitle instanceof  TabView){
                        nextTitleTextView=((TabView)nextTitle).getmTextView();
                    }

                    left = (int) (mSelectionOffset * (nextTitle.getLeft()+nextTitleTextView.getLeft()) +
                            (1.0f - mSelectionOffset) * left);
                    right = (int) (mSelectionOffset *(nextTitle.getLeft()+nextTitleTextView.getRight()) +
        ...
        void animateIndicatorToPosition(final int position, int duration) {
            ...
            if (targetView == null) {
             ...
             //修改部分
            View targetViewTextView =null;
            if (targetView instanceof TabView){
                targetViewTextView=((TabView)targetView).getmTextView();
            }
            final int targetLeft = targetView.getLeft()+targetViewTextView.getLeft();
            final int targetRight = targetView.getLeft()+targetViewTextView.getRight();
//
...
//            final int targetRight = targetView.getRight();
    ...
    private int getDefaultHeight() {
        ...
        for (int i = 0, count = mTabs.size(); i < count; i++) {
            ZTabLayout.Tab tab = mTabs.get(i);
     ...
     * necessary calls back to the provided {@link ZTabLayout} so that the tab position is
     * kept in sync.
     *
    ...
    public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        private final WeakReference<ZTabLayout> mTabLayoutRef;
        private int mPreviousScrollState;
        private int mScrollState;

        public TabLayoutOnPageChangeListener(ZTabLayout tabLayout) {
        ...
        public void onPageScrolled(final int position, final float positionOffset,
            ...
            final ZTabLayout tabLayout = mTabLayoutRef.get();
            if (tabLayout != null) {
    ...
    /**
     * A {@link ZTabLayout.OnTabSelectedListener} class which contains the necessary calls back
     * to the provided {@link ViewPager} so that the tab position is kept in sync.
     */
    public static class ViewPagerOnTabSelectedListener implements ZTabLayout.OnTabSelectedListener {
